...
# Unit tests for Omnichannel::OmniMessageCreateSuccessResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'OmniMessageCreateSuccessResponse' do
  before do
    # run before each test
    @instance = Omnichannel::OmniMessageCreateSuccessResponse.new
  end
  ...
  describe 'test an instance of OmniMessageCreateSuccessResponse' do
    it 'should create an instance of OmniMessageCreateSuccessResponse' do
      expect(@instance).to be_instance_of(Omnichannel::OmniMessageCreateSuccessResponse)
    end
  end
